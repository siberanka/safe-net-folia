 ...
 */
package dev.dejvokep.safenet.folia.listener.handshake;
...
public abstract class AbstractHandshakeListener {
    ...
    public AbstractHandshakeListener(SafeNetFolia plugin, boolean pingBlockingAvailable) {
        this.plugin = plugin;

 ...
 */
package dev.dejvokep.safenet.folia.authentication;
...
import dev.dejvokep.safenet.folia.authentication.result.AuthenticationResult;
import dev.dejvokep.safenet.folia.authentication.result.HandshakeAuthenticationResult;
...
public class Authenticator {
     ...
     */
    public Authenticator(@NotNull SafeNetFolia plugin) {
        // Set
        this.plugin = plugin;
